        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DonorAveilableStatus = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ApplicationUserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    HospitalDataId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedOn = table.Column<DateTime>(type: "datetime2", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserDonorId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedOn = table.Column<DateTime>(type: "datetime2", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecipientHospitalData", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RecipientHospitalData_HospitalData_HospitalDataId",
                        column: x => x.HospitalDataId,
                        principalTable: "HospitalData",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecipientEmergency = table.Column<int>(type: "int", nullable: false),
                    RequestId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    HospitalDataId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    BloodGroup = table.Column<int>(type: "int", nullable: false),
                    RhesusFactor = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RecipientRequests_Recipients_RecipientId",
                        column: x => x.RecipientId,
                        principalTable: "Recipients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipientHospitalData_HospitalDataId",
                table: "RecipientHospitalData",
                column: "HospitalDataId");

            migrationBuilder.CreateIndex(
                name: "IX_RecipientHospitalData_IsDeleted",
                table: "RecipientHospitalData",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_RecipientHospitalData_RecipientId",
                table: "RecipientHospitalData",
                column: "RecipientId");

            migrationBuilder.CreateIndex(
                name: "IX_RecipientRequests_IsDeleted",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipientRequests_RequestId",
                table: "RecipientRequests",
                column: "RequestId");
